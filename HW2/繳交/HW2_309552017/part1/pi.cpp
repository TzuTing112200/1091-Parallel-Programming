...
float getPI()
{
    ...
    part_number_of_tosses = number_of_tosses * 1.2 / number_of_CPU_cores;
    part_number_of_tosses = part_number_of_tosses - part_number_of_tosses % number_of_CPU_cores;
    ...
    float pi_estimate = 4.0 * number_in_circle / (part_number_of_tosses * number_of_CPU_cores);
