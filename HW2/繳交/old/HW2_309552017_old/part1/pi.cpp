...
float getPI()
{
    ...
    part_number_of_tosses = number_of_tosses / number_of_CPU_cores * 1.1;
	if(number_of_CPU_cores > 4)  part_number_of_tosses *= 1.25;
