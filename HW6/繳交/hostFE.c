            ...
            cl_context *context, cl_program *program)
{
    ...
    d_inputImage = clCreateBuffer(*context, CL_MEM_USE_HOST_PTR, imageSize, inputImage, NULL);
    d_outputImage = clCreateBuffer(*context, CL_MEM_WRITE_ONLY, imageSize, NULL, NULL);
    d_filter = clCreateBuffer(*context, CL_MEM_USE_HOST_PTR, filterSize, filter, NULL);
